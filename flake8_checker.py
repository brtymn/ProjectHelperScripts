...
get_shell_statement = "flake8 " + str(project_file_path) ## Initialize the string that will be executed in the shell.
os.system(get_shell_statement)  ## Execute the predefined string in the shell.
